...
- Se define una clase llamada `Config` que se utiliza para almacenar configuraciones de la aplicación.
...
#### Atributo `SQLALCHEMY_DATABASE_URI`
...
#### Atributo `SQLALCHEMY_TRACK_MODIFICATIONS`
...
- **repr**: Es un método especial que define cómo se representa el objeto `Producto` como una cadena. Esto es útil para depuración y logging. En este caso, devuelve una cadena que incluye el nombre del producto.
